...
function memberOk() {
    ...
    f.action = "<%=cp%>/member/find_password";
...
<div class="body-container" style="width: 700px;">
    <div class="body-title">
        <h3><span style="font-family: Webdings">2</span>비밀번호 찾기</h3>
    </div>
			...
			<form name="memberForm" method="post">
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        ...
			        <p class="help-block">회원 가입 시, 입력한 아이디를 입력하세요</p>
			      </td>
			  </tr>
			  ...
			  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        <button type="button" name="sendButton" class="btn" onclick="memberOk();">비밀번호 찾기</button>
			      </td>
			    </tr>
			    <tr height="30">
