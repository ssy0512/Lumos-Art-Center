...
function memberOk() {
	...
	if(str!= f.userPwdCheck.value) {
        alert("패스워드를 입력하지않거나 패스워드가 일치하지 않습니다. ");
...
<div class="body-container" style="width: 700px;">
    <div class="body-title">
        <h3><span style="font-family: Webdings">2</span>${mode=="created"?"일반 회원 가입":"일반 회원 정보 수정"} </h3>
    </div>
			...
			<form name="memberForm" method="post">
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        ...
			        <p class="help-block">이메일은 아이디 및 패스워드를 찾기위한 필수 입력사항입니다.</p>
			      </td>
			  </tr>
