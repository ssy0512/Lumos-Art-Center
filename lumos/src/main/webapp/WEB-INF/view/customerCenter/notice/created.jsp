    ...
    <div>
			<form name="boardForm" method="post" enctype="multipart/form-data">
			  ...
			  <tr align="left" height="40" style="border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc;"> 
			      <td width="100" bgcolor="#fafafa" style="text-align: center;">제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
			  ...
			  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;"> 
			      <td width="100" bgcolor="#fafafa" style="text-align: center;">공지여부</td>
			      <td style="padding-left:10px;"> 
			            <input type="checkbox" name="important" value="1" ${dto.important==1 ? "checked='checked' ":"" } > 공지
			      </td>
			  </tr>
			  
			  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;"> 
			      <td width="100" bgcolor="#fafafa" style="text-align: center;">작성자</td>
			      <td style="padding-left:10px;"> 
