    ...
    $("input[name=endDay]").datepicker();
            ...
            <form class="form-horizontal" name="schForm" method="post">
                <div class="form-group">
                    <label class="col-sm-2 control-label">공연 이름</label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">장소선택</label>
                    <div class="col-sm-10"  id="schClassify">
                        <div class="btn-group" id="classifyGroup">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href='javascript:classifyChange("blue");'>콘서트홀</a></li>
                                <li><a href='javascript:classifyChange("black");'>오페라극장</a></li>
                                <li><a href='javascript:classifyChange("green");'>자유소극장</a></li>
                                <li><a href='javascript:classifyChange("tomato");'>리사이틀홀</a></li>
                            </ul>
                        </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">공연시작일</label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">공연종료일</label>
                ...
                <div class="form-group" id="schContent"  style="min-height: 75px;">
                    <label class="col-sm-2 control-label">상&nbsp;세</label>
                    <div class="col-sm-10">
