...
<table style="margin: 10px auto 0px; width: 100%; border-spacing: 0px;">
		  ...
		  <tr height="40"> 
		      ...
		      <td> 
                     <span id="schhall"></span>
              </td>
		  </tr>
			 <tr height="40"> 
		     <td width="100"style="font-weight:600; padding-right:15px; text-align: right;">위&nbsp;&nbsp;치</td>
		     <td> 
		  ...
		  <tr height="40"> 
		      <td width="100"style="font-weight:600; padding-right:15px; text-align: right;">전시명</td>
		      <td> 
                     <span id="schexhibit"></span>
              </td>
		  </tr>
