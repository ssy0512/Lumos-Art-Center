...
$(function() {
	var url="<%=cp%>/admin/sales/concert/ConcertBar";
...
$(function() {
	var url="<%=cp%>/admin/sales/concert/ConcertSales";
	$.getJSON(url, function (csv) {
		var subject=csv.subject;
...
$(function() {
	var url="<%=cp%>/admin/sales/concert/ConcertPie3d";
	$.getJSON(url, function (csv) {
...
<div class="body-right" style="width: 1380px; height: 800px;">
	<div style="clear: both;">
		<div id="barContainer" style="width: 480px; height: 350px; float: left; margin: 0px; border-right: 1px solid #eee;"></div>
		<div id="salesContainer" style="width: 480px; height: 350px; float: left; margin: 0px; border-right: 1px solid #eee;"></div>
		<div id="pie3dContainer" style="width: 380px; height: 350px; float: left; margin: 0px; border-right: 1px solid #eee;"></div>
	</div>
	...
	<div style="width: 902px; height: 450px; float: left;">
		<div style="width: 902px; height: 30px; background-color: #6fa8dc; color: #ffffff; float: left;">
			<p style="font-size: 13pt; float:left; margin-left: 350px">진행중인 공연</p>
	...
	<div style="width: 470px; height: 450px; float: right;">
		<div style="width: 470px; height: 30px; background-color: #6fa8dc; color: #ffffff; float: left;">
			<p style="font-size: 13pt; float:left; margin-left: 200px">지난 공연</p>
			<p style="font-size: 13pt; float: right; margin-right: 20px">더보기</p>
		</div>
		<div style="width: 470px; height:415px; border: 1px solid #eee; float: left;">
			<div style="width: 115px; height: 30px; border: 1px solid #eee; float: left;"><p>공연 제목</p></div>
