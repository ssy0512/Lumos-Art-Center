...
var memberEmail = "${memberDTO.email}";
...
function memberOk() {
    ...
    f.action = "<%=cp%>/mypage/member/member?changepwd=" + chkpwd;
    f.submit();
}
...
function checkChangePwd()
{
	...
	if(chk == true)
	{
		...
		$("#userPwdCheck").prop("readonly", false);
	}
	else
	{
		$("#userPwd").prop("readonly", true);
		$("#userPwdCheck").prop("readonly", true);
	}
}
...
<div class="body-container" style="width: 700px;">
    <div class="body-title">
        <h3><span style="font-family: Webdings">2</span>&nbsp; 개인 회원 정보 수정 </h3>
    </div>
        ...
        <div>
			<form name="memberForm" method="post">
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            ...
			            <input type="text" name="phone" id="phone" onkeyup="checkPhoneNumber()" value="${memberDTO.phone}" class="boxTF" maxlength="13">
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="text" name="zip" id="zip" value="${memberDTO.zip}"
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="text" name="address1" id="address1"  value="${memberDTO.address1}" maxlength="50" 
			                       class="boxTF" style="width: 95%;" placeholder="기본 주소" readonly="readonly">
			        </p>
			        <p style="margin-bottom: 5px;">
			            <input type="text" name="address2" id="address2" value="${memberDTO.address2}" maxlength="50" 
			...
			<tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="password" name="userPwd" id="userPwd" maxlength="15" class="boxTF"
			                       style="width:95%;" placeholder="" readonly="readonly">
			        </p>
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="password" name="userPwdCheck" id="userPwdCheck" maxlength="15" class="boxTF"
			                       style="width: 95%;" placeholder="" readonly="readonly">
			        </p>
