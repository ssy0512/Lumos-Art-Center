...
public class AdminUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		sb.append("#paginate .curBox {border:1px solid #072659; background: #fff; color:#072659; font-weight:bold;height:28px;padding:4px 7px 4px 7px;margin-left:3px;line-height:normal;vertical-align:middle;}");
