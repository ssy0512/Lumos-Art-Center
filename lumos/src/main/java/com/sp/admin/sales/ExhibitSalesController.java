...
public class ExhibitSalesController {
	...
	@RequestMapping(value="/admin/sales/exhibit/listCards")
	public String listCards(
        ...
        String query = "";
        String listUrl = cp+"/admin/sales/exhibit/listCards";
        String articleUrl = cp+"/admin/sales/exhibit/article?page="+current_page;
        if(searchValue.length()!=0) {
        ...
        if(query.length()!=0) {
        	listUrl = cp+"/admin/sales/exhibit/listCards?"+query;
        	articleUrl = cp+"/admin/sales/exhibit/article?page=" + current_page + "&"+ query;
        }
		...
		return ".admin4.sales.exhibit.listCards";
	}
